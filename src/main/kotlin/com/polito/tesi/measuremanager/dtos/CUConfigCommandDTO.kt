...
data class MeasureCUConfigRequest(val cuid: Long, val sensors: List<MeasureMUConfigRequest>)

data class MeasureMUConfigRequest(
        val extendedId: Long,
        val sensorId: Long,
        val configurationMeasure: String
)
