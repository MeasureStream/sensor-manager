...
internal class NodeControllerTest
    ...
    constructor(val mockMvc: MockMvc) {
        ...
        fun `Create a node and verify it is correctly saved`() {
            upload_Node(
                NodeDTO(11, "node-11", false, setOf(), setOf(), Point(Random.nextDouble(-180.0, 180.0), Random.nextDouble(-90.0, 90.0))),
            )
        }
        ...
        fun `Verify that a node without a name is not saved`() {
            update_Node(
                NodeDTO(10, "   ", false, setOf(), setOf(), Point(Random.nextDouble(-180.0, 180.0), Random.nextDouble(-90.0, 90.0))),
                status().isConflict,
            )
        }
        ...
        fun `Add a ControlUnit Already Assigned to a Node `() {
            ...
            update_Node(
                NodeDTO(
                    ...
                    "node-11",
                    false,
                    controlUnitsId = setOf(8, 1),
                    measurementUnitsId = setOf(8),
                    Point(Random.nextDouble(-180.0, 180.0), Random.nextDouble(-90.0, 90.0)),
                ),
                status().isConflict,
            )
        }
        ...
        fun `Add a ControlUnit not Already Assigned to a Node `() {
            ...
            update_Node(
                NodeDTO(
                    ...
                    "node-11",
                    false,
                    controlUnitsId = setOf(9, 1),
                    measurementUnitsId = setOf(9, 19),
                    Point(Random.nextDouble(-180.0, 180.0), Random.nextDouble(-90.0, 90.0)),
                ),
                status().isAccepted,
            )
        ...
        fun `Add a MeasurementUnit Already Assigned to a Node`() {
            ...
            update_Node(
                NodeDTO(
                    ...
                    "node-10",
                    false,
                    controlUnitsId = setOf(8),
                    measurementUnitsId = setOf(8, 1),
                    Point(Random.nextDouble(-180.0, 180.0), Random.nextDouble(-90.0, 90.0)),
                ),
                status().isConflict,
            )
        ...
        fun `Add a MeasurementUnit not Already Assigned to a Node`() {
            ...
            update_Node(
                NodeDTO(
                    ...
                    "node-10",
                    false,
                    controlUnitsId = setOf(5),
                    measurementUnitsId = setOf(5, 15, 1),
                    Point(Random.nextDouble(-180.0, 180.0), Random.nextDouble(-90.0, 90.0)),
                ),
                status().isAccepted,
            )
